        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            <p className="text-lg text-slate-400 max-w-xl leading-relaxed">
              Education isn't linear. It's a network. We map the hidden dependencies between 8,000+ concepts to identify the 
              <span className="text-white font-semibold"> root cause </span> 
              of every student's struggle.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button className="group relative px-8 py-4 bg-white text-black font-bold rounded-lg overflow-hidden transition-all hover:scale-105 active:scale-95">
              ...
              <button className="px-8 py-4 glass-panel text-white font-semibold rounded-lg hover:bg-white/10 transition-colors flex items-center gap-2">
